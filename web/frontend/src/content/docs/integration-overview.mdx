...
<CodeTabs
  codes={{
    npm: "npm install x402@npm:@x402x/x402@0.6.6-patch.5",
    pnpm: "pnpm add x402@npm:@x402x/x402@0.6.6-patch.5",
    yarn: "yarn add x402@npm:@x402x/x402@0.6.6-patch.5",
    bun: "bun add x402@npm:@x402x/x402@0.6.6-patch.5",
  }}
  lang="bash"
/>
