...
<CodeTabs
  codes={{
    npm: "npm install x402@npm:@x402x/x402@0.6.6-patch.7",
    pnpm: "pnpm add x402@npm:@x402x/x402@0.6.6-patch.7",
    yarn: "yarn add x402@npm:@x402x/x402@0.6.6-patch.7",
    bun: "bun add x402@npm:@x402x/x402@0.6.6-patch.7",
  }}
  lang="bash"
/>
