...
<CodeTabs
  codes={{
    npm: "npm install @x402x/client @x402x/extensions @x402/fetch viem",
    pnpm: "pnpm add @x402x/client @x402x/extensions @x402/fetch viem",
    yarn: "yarn add @x402x/client @x402x/extensions @x402/fetch viem",
    bun: "bun add @x402x/client @x402x/extensions @x402/fetch viem",
  }}
  lang="bash"
/>
